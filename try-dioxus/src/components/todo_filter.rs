...
pub fn todo_filter<'a>(cx: Scope<'a, TodoFilterProps<'a>>) -> Element {
    ...
    let items_left = todos
        .iter()
        .fold(0, |acc, (_,todo)| if todo.completed { acc } else { acc + 1 } );
            ...
            footer { class: "footer",
                ...
                ul {
                    ...
                    li {
                        a { 
                            class: "{all_class}",
                            href:"#/", onclick: move |_| set_filter(Filter::All), "All" 
                        },
                    },
                    li {
                        a { 
                            class: "{active_class}",
                            href:"#/active", onclick: move |_| set_filter(Filter::Active), "Active"
                        },
                    },
                    li {
                        a {
                            class: "{completed_class}",
                            href:"#/completed", onclick: move |_| set_filter(Filter::Completed), "Completed" 
                        },
                    },
                }
